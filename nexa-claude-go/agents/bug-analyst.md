...
- Ground every claim in a specific file and line. "The validation logic is probably wrong" is
  not acceptable; "the discount is applied to line items in `internal/order/views.templ:42` but
  `internal/order/service.go:88` recomputes the total from `item.OriginalPrice`, not the discounted
  price" is.
