...
name: karibu-test
description: >
  Creates Karibu server-side integration tests for Vaadin views covering navigation,
  component interactions, form validation, grid operations, and notifications
  using Testcontainers for external dependencies. Use when the user asks to
  "write Karibu integration tests", "test views with a real database",
  "create view integration tests", or mentions Karibu integration testing or
  Testcontainers. Unit tests are created by the implement skill.
---

# Karibu Integration Test
