...
1. **Read the project context**:
   - Check the existing Dockerfile(s) to determine the exposed port(s)
   ...
   - For NestJS + Next.js projects, determine whether to deploy one or both services (backend, frontend, or both)
...
3. **Create the GitHub Actions workflow** at `.github/workflows/deploy-<app-name>.yml`:
   ...
   - For multi-service projects, create a job per service or a single workflow that builds both images
...
- **Deploy script**: `~/.claude/plugins/cache/nexa-claude-marketplace/nexa-claude-nestjs-nextjs/1.0.0/skills/aws-setup-apprunner/templates/deploy-apprunner.sh`
- **GitHub Actions workflow**: `~/.claude/plugins/cache/nexa-claude-marketplace/nexa-claude-nestjs-nextjs/1.0.0/skills/aws-setup-apprunner/templates/github-actions/deploy-ecr-apprunner.yml`
