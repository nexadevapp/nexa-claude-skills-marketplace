...
Re-run /sprint-prepare to generate them from refined requirements.

Do NOT run /deliver-use-case directly — it would generate specs from
broad requirements instead of the sprint-refined ones.
```
