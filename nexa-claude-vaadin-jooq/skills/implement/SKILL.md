...
name: implement
description: >
  Implements use cases and fixes bugs by creating Vaadin views, forms, and grids for the UI
  layer and jOOQ queries for the data access layer. Use when the user asks to
  "implement a use case", "fix a bug", "build the UI", "create a Vaadin view", "write the
