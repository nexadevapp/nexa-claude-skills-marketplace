...
### 5. Prioritize what to build first → `/prioritize`
...
### 7. Write detailed specs → `/use-case-spec`
...
### 13. Implement use cases → `/implement`
...
### 15. Check code quality → `/code-quality`

Runs ESLint and Prettier to enforce consistent formatting and catch issues.

### 16. Or just deliver end-to-end → `/deliver-use-case`

This single command orchestrates steps 7 through 15 automatically for a use case, iterating until all quality gates pass. Use this when you want hands-off delivery.

---

### 17. Review and evaluate
...
### 18. Deploy → `/aws-dockerize` + `/aws-setup-apprunner`
